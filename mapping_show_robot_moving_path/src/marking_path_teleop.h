...
class Mapping_MarkingPathAndTeleop : public rviz::Panel
{
Q_OBJECT

public:
    Mapping_MarkingPathAndTeleop(QWidget* parent = 0);
...
private Q_SLOTS:
    ...
    void mapping_update();
    void mappingPoseCallback(const geometry_msgs::Pose::ConstPtr& msg);
